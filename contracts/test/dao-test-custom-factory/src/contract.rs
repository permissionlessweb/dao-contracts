...
use cw721::{
    msg::{Cw721InstantiateMsg, Cw721QueryMsg, NumTokensResponse},
...
pub fn execute_nft_factory(
    ...
    let msg = to_json_binary(&Cw721InstantiateMsg::<EmptyOptionalCollectionExtension> {
...
pub fn reply(deps: DepsMut, env: Env, msg: Reply) -> Result<Response, ContractError> {
    match msg.result {
        cosmwasm_std::SubMsgResult::Ok(ref res) => {
            match msg.id {
                INSTANTIATE_ISSUER_REPLY_ID => {
                        ...
                        .addr_validate(
                            &res.events
                                ...
                                .ok_or_else(|| ContractError::ReplyParseError {
                                    err: " not found in reply".to_string(),
                                })?
                                .value,
                        )?
                        .into_string();
                    ...
                    let active_threshold: ActiveThresholdResponse = deps.querier.query_wasm_smart(
                        voting_module,
                        &ActiveThresholdQuery::ActiveThreshold {},
                    )?;
